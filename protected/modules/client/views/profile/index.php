...
<div class="row-fluid">
    <div class="span3">
        ...
        <div style="margin: 20px 15px 20px 15px">
            <a href="<?php echo Yii::app()->createUrl('client/profile/editfoto');?>" data-toggle="modal" data-backdrop="static" onclick="showOnModal(jQuery(this).attr('href'))" class="btn btn-small btn-success"><i class="icon-folder-open icon-white"></i> Ubah Foto</a>
