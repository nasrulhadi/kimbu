...
<?php echo $form->errorSummary($model); ?>
    ...
    <div class="row">
        ...
        <?php
        echo $form->dropDownList($model, 'ID_DIVISI', Divisi::getAll(), array(
            //'class'=>'uniformselect',
            'prompt' => 'Pilih Divisi',
            'style' => 'width:250px;'
        ));
...
<?php
echo $form->radioButtonList($model, 'STATUS', array(User::STATUS_AKTIF => 'Aktif', User::STATUS_NON_AKTIF => 'Tidak Aktif'), array(
    'separator' => '',
));
?>
