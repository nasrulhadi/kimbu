...
<div class="row-fluid">
    <div class="span4">
        ...
        <div style="margin-top: 20px;">
            <a href="<?php echo Yii::app()->createUrl('admincs/user/editfoto/'.$model->ID_USER);?>" data-toggle="modal" data-backdrop="static" onclick="showOnModal(jQuery(this).attr('href'))" class="btn btn-large btn-success"><i class="icon-folder-open icon-white"></i> Ubah Foto</a>
