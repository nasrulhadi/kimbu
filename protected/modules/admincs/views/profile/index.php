...
<!--            <a href="<?php //echo Yii::app()->request->baseUrl; ?>/file/foto/<?php //echo $model->FOTO; ?>" rel="gallery" class="cboxElement"><?php //echo $model->displayPicture($model->FOTO);?></a>-->
        <div class="profilethumb">
            <a href="<?php echo Yii::app()->createUrl('admincs/profile/editfoto');?>" data-toggle="modal" onclick="showOnModal(jQuery(this).attr('href'))" style="display: inline;"><i class="icon-folder-open icon-white"></i> Ubah Foto</a>
